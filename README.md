...
![Status](https://img.shields.io/badge/Estado-WIP-orange) ![Materia](https://img.shields.io/badge/Materia-Lengua_y_Literatura-blue) ![Nivel](https://img.shields.io/badge/Nivel-2º_Bachillerato-green) ![Licencia](https://img.shields.io/badge/Licencia-CC_BY--NC--SA_4.0-lightgrey)

## 🏛️ Introducción y Propósito
...
El repositorio se organiza siguiendo la lógica temporal y temática de las Situaciones de Aprendizaje (SdA) diseñadas:

### 🌫️ SdA 4: "El alma del paisaje" (Fin de Siglo y 98)
*Crisis de conciencia, abulia nacional y la búsqueda de la esencia en el páramo castellano.*

* **📜 `SJB - La literatura finisecular - Modernismo y Generación del 98.pdf`**: Dossier teórico.
* **📖 `SJB - Poemas de la lírica finisecular.pdf`**: Selección de textos.
